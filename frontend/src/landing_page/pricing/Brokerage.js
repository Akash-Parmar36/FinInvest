// App.js or a dedicated Line component
import React, { useState } from "react";

function Brokerage() {
  return (
    <div className="container-lg px-sm-4 px-lg-0 px-xl-5 pb-5 mb-5">

        <h2 className="brokerage_h2">Charges explained</h2>
        
       <div className="brokerage_flex">
         
                <div className="brokerage_six brokerage_columns">
                  <h2 className="brokerage_col_h2">
                    Securities/Commodities transaction tax
                  </h2>
                  <p className="brokerage_col_p_text">
                  ...
                  <ul className="brokerage_ul">
                    ...
                    <li className="mb-2">
                      MTF Brokerage: 0.3% or &#8360;. 20/executed order, whichever is
                      lower.
                    </li>
                    <li className="mb-2">
